...
namespace Playground.Domain.Persistence.PostgreSQL.IntegrationTests
{
    ...
    {
        private EventRepositoryForGenericIdentity _sut;
        ...
        public async Task CreateStream_WillCreateStream_WhenStreamIdIsValid()
        {
            ...
            var expectedStream = new EventStreamForGenericIdentity
            {
                EventStreamId = streamId,
                EventStreamName = streamName
            };
        ...
        [TestCase("")]
        [TestCase("    ")]
        public void CreateStream_WillThrowException_WhenStreamIdIsInvalid(string invalidStreamId)
        {
            // arrange
            var streamName = Fixture.Create<string>();

            Func<Task> exceptionThrower = async () => await _sut
                .CreateStream(invalidStreamId, streamName)
                .ConfigureAwait(false);
        ...
        public async Task CreateStream_WillThrowException_WhenStreamIdAlreadyExists()
        {
            ...
            await DatabaseHelper
                .CreateEventStreamGeneric(streamId, streamName)
                .ConfigureAwait(false);
        ...
        [TestCase("")]
        [TestCase("    ")]
        public void CheckStream_WillThrowException_WhenStreamIdIsInvalid(string invalidStreamId)
        {
            // arrange
            Func<Task> exceptionThrower = async () => await _sut
                .CheckStream(invalidStreamId)
                .ConfigureAwait(false);
        ...
        public async Task GetAll_WillReturnAllEvents_WhenThereAreEventsForStream()
        {
            ...
            await DatabaseHelper
                .CreateEventGeneric(streamId, event1)
                .ConfigureAwait(false);
            await DatabaseHelper
                .CreateEventGeneric(streamId, event2)
                .ConfigureAwait(false);
        ...
        [TestCase("")]
        [TestCase("    ")]
        public void GetAll_WillThrowException_WhenStreamIdIsInvalid(string invalidStreamId)
        {
            // arrange
            Func<Task> exceptionThrower = async () => await _sut
                .GetAll(invalidStreamId)
                .ConfigureAwait(false);
        ...
        public async Task GetSelected_WillReturnSelectedEvents_WhenThereAreEventsForSelectedBitOfStream()
        {
            ...
            await DatabaseHelper
                ...
                .ConfigureAwait(false);
            await DatabaseHelper
                .CreateEventGeneric(streamId, event3)
                .ConfigureAwait(false);
        ...
        [TestCase("")]
        [TestCase("    ")]
        public void GetSelected_WillThrowException_WhenStreamIdIsInvalid(string invalidStreamId)
        {
            // arrange
            Func<Task> exceptionThrower = async () => await _sut
                .GetSelected(invalidStreamId, 0L)
                .ConfigureAwait(false);
        ...
        [TestCase("")]
        [TestCase("    ")]
        public void GetLast_WillThrowException_WhenStreamIdIsInvalid(string invalidStreamId)
        {
            // arrange
            Func<Task> exceptionThrower = async () => await _sut
                .GetLast(invalidStreamId)
                .ConfigureAwait(false);
        ...
        public async Task Add_WillAddEvents_ToEmptyStream()
        {
            ...
            // assert
            var actualEvents = await DatabaseHelper
                .GetStreamEventsGeneric(streamId)
                .ConfigureAwait(false);
        ...
        public async Task Add_WillAddEvents_ToStreamWithEvents()
        {
            ...
            await DatabaseHelper
                .CreateEventGeneric(streamId, evt1)
                .ConfigureAwait(false);
            await DatabaseHelper
                .CreateEventGeneric(streamId, evt2)
                .ConfigureAwait(false);
        ...
        [TestCase("")]
        [TestCase("    ")]
        public void Add_WillThrowException_WhenStreamIdIsInvalid(string invalidStreamId)
        {
            // arrange
            Func<Task> exceptionThrower = async () => await _sut
                .Add(invalidStreamId, new List<StoredEvent>())
                .ConfigureAwait(false);
